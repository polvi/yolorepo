/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0257ddb1020a0a68afd462d22d2bff61)
// Runtime types generated with workerd@1.20260714.1 2026-07-01 
interface __BaseEnv_Env {
	// AuthGravity origin for this deployment, rendered into wrangler.jsonc
	// vars by `bun run configure`; optional so configs that predate the var
	// still typecheck (auth.ts falls back to the proc.io endpoint).
	AUTH_ENDPOINT?: string;
	DB: D1Database;
	ENGINE: Fetcher /* tlc-engine */;
}
